...
NS_INTERFACE_MAP_BEGIN(nsDOMWindowUtils)
  ...
  NS_INTERFACE_MAP_ENTRY(nsIDOMWindowUtils_1_9)
                                          ...
                                          PRBool *aRetVal)
{
  ...
  nsCOMPtr<nsICSSParser_1_9> pext(do_QueryInterface(parser));
  NS_ABORT_IF_FALSE(pext, "nsICSSParser_1_9 missing from parser impl");
